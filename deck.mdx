...
<Author>
<b>Jan Schering</b><sup>1</sup>, Sander Keemink<sup>2</sup>, Johannes Textor<sup>1</sup>
</Author>
<br />
<small><sup>1</sup>
...
ECMS 2024 - Track Simulation and Optimization
</p>

<div style={{textAlign: "-webkit-center"}}>
<p style={{fontSize: 18, marginTop: 50, width: 700, alignSelf: "center"}}>
    Part of the research presented was performed for an ELLIS excellence fellowship,
    funded by Radboud AI, Radboud University. This research was further supported by HFSP
    program grant RGP0053/2020.
</p>
</div>
...
<div style={{display: "flex", flexDirection: "column"}}>
    <div style={{flexDirection: "row", display: "flex"}}>
        <img style={{height: 280, display: "flex"}} src={noGrad1} />
        <img style={{height: 280, display: "flex"}} src={noGrad2} />
    </div>
    <div style={{alignSelf: "center", display: "flex"}}>
        <img style={{height: 280,}} src={noGrad3} />
    </div>
</div>
...
<div>
    <img style={{height: 600}} src={siApproach}>
    </img>
</div>
